...
with c1:
    ...
    st.write("- [_Mateo Zarza_](https://www.linkedin.com/in/mateozarza/)")
    st.write("- [_Luis Carrero_](https://linkedin.com/in/luisgcarrero)")
    st.write("- [_Matias Arias_](https://www.linkedin.com/in/matias-valentin-arias-/)")
